...
if raw_facts and st.button("🔍 Generate Chronological Fact Pattern"):
    ...
    with st.spinner("Generating fact pattern..."):
        prompt = f"""You are a legal assistant. Based only on the factual information below (extracted from police reports, affidavits, and interviews), generate a neutral, strictly chronological, paragraph-based fact pattern suitable for a suppression motion. Do NOT infer or invent content. Label unclear details as (Unclear). Do NOT include legal conclusions.
